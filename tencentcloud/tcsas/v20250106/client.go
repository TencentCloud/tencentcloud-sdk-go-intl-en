...
func NewConfigureMNGPreviewRequest() (request *ConfigureMNGPreviewRequest) {
    request = &ConfigureMNGPreviewRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    
    request.Init().WithApiInfo("tcsas", APIVersion, "ConfigureMNGPreview")
    
    
    return
}

func NewConfigureMNGPreviewResponse() (response *ConfigureMNGPreviewResponse) {
    response = &ConfigureMNGPreviewResponse{
        BaseResponse: &tchttp.BaseResponse{},
    } 
    return
...
func (c *Client) ConfigureMNGPreviewWithContext(ctx context.Context, request *ConfigureMNGPreviewRequest) (response *ConfigureMNGPreviewResponse, err error) {
    ...
    c.InitBaseRequest(&request.BaseRequest, "tcsas", APIVersion, "ConfigureMNGPreview")
    
    if c.GetCredential() == nil {
        return nil, errors.New("ConfigureMNGPreview require credential")
    }

    request.SetContext(ctx)
    
    response = NewConfigureMNGPreviewResponse()
    err = c.Send(request, response)
    return
}
...
func NewCreateMNGRequest() (request *CreateMNGRequest) {
    request = &CreateMNGRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    
    request.Init().WithApiInfo("tcsas", APIVersion, "CreateMNG")
    
    
    return
}

func NewCreateMNGResponse() (response *CreateMNGResponse) {
    response = &CreateMNGResponse{
        BaseResponse: &tchttp.BaseResponse{},
    } 
    return
...
func (c *Client) CreateMNG(request *CreateMNGRequest) (response *CreateMNGResponse, err error) {
    return c.CreateMNGWithContext(context.Background(), request)
}
...
//  INVALIDPARAMETERVALUE_MNPTYPENUMBEREXCEEDLIMIT = "InvalidParameterValue.MNPTypeNumberExceedLimit"
//  INVALIDPARAMETERVALUE_MINIPROGRAMNAMEALREADYEXIST = "InvalidParameterValue.MiniProgramNameAlreadyExist"
func (c *Client) CreateMNGWithContext(ctx context.Context, request *CreateMNGRequest) (response *CreateMNGResponse, err error) {
    if request == nil {
        request = NewCreateMNGRequest()
    }
    c.InitBaseRequest(&request.BaseRequest, "tcsas", APIVersion, "CreateMNG")
    
    if c.GetCredential() == nil {
        return nil, errors.New("CreateMNG require credential")
    }

    request.SetContext(ctx)
    
    response = NewCreateMNGResponse()
    err = c.Send(request, response)
    return
}
...
func NewCreateMNGApprovalRequest() (request *CreateMNGApprovalRequest) {
    ...
    request.Init().WithApiInfo("tcsas", APIVersion, "CreateMNGApproval")
    
    
    return
}

func NewCreateMNGApprovalResponse() (response *CreateMNGApprovalResponse) {
    response = &CreateMNGApprovalResponse{
        BaseResponse: &tchttp.BaseResponse{},
    } 
    return
...
func (c *Client) CreateMNGApproval(request *CreateMNGApprovalRequest) (response *CreateMNGApprovalResponse, err error) {
    return c.CreateMNGApprovalWithContext(context.Background(), request)
}
...
//  INVALIDPARAMETERVALUE_MNPAPPROVALSTATUSERROR = "InvalidParameterValue.MNPApprovalStatusError"
//  INVALIDPARAMETERVALUE_MNPVERSIONISNOTPLATFORMPHASE = "InvalidParameterValue.MNPVersionIsNotPlatformPhase"
func (c *Client) CreateMNGApprovalWithContext(ctx context.Context, request *CreateMNGApprovalRequest) (response *CreateMNGApprovalResponse, err error) {
    if request == nil {
        request = NewCreateMNGApprovalRequest()
    }
    c.InitBaseRequest(&request.BaseRequest, "tcsas", APIVersion, "CreateMNGApproval")
    
    if c.GetCredential() == nil {
        return nil, errors.New("CreateMNGApproval require credential")
    }

    request.SetContext(ctx)
    
    response = NewCreateMNGApprovalResponse()
    err = c.Send(request, response)
    return
}

func NewCreateMNGDomainACLRequest() (request *CreateMNGDomainACLRequest) {
    request = &CreateMNGDomainACLRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    
    request.Init().WithApiInfo("tcsas", APIVersion, "CreateMNGDomainACL")
    
    
    return
}

func NewCreateMNGDomainACLResponse() (response *CreateMNGDomainACLResponse) {
    response = &CreateMNGDomainACLResponse{
        BaseResponse: &tchttp.BaseResponse{},
    } 
    return
...
func (c *Client) CreateMNGDomainACLWithContext(ctx context.Context, request *CreateMNGDomainACLRequest) (response *CreateMNGDomainACLResponse, err error) {
    if request == nil {
        request = NewCreateMNGDomainACLRequest()
    }
    c.InitBaseRequest(&request.BaseRequest, "tcsas", APIVersion, "CreateMNGDomainACL")
    
    if c.GetCredential() == nil {
        return nil, errors.New("CreateMNGDomainACL require credential")
    }

    request.SetContext(ctx)
    
    response = NewCreateMNGDomainACLResponse()
    err = c.Send(request, response)
    return
}

func NewCreateMNGSensitiveAPIPermissionApprovalRequest() (request *CreateMNGSensitiveAPIPermissionApprovalRequest) {
    request = &CreateMNGSensitiveAPIPermissionApprovalRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    
    request.Init().WithApiInfo("tcsas", APIVersion, "CreateMNGSensitiveAPIPermissionApproval")
    
    
    return
}

func NewCreateMNGSensitiveAPIPermissionApprovalResponse() (response *CreateMNGSensitiveAPIPermissionApprovalResponse) {
    response = &CreateMNGSensitiveAPIPermissionApprovalResponse{
        BaseResponse: &tchttp.BaseResponse{},
    } 
    return
...
// CreateMNGSensitiveAPIPermissionApproval
...
func (c *Client) CreateMNGSensitiveAPIPermissionApprovalWithContext(ctx context.Context, request *CreateMNGSensitiveAPIPermissionApprovalRequest) (response *CreateMNGSensitiveAPIPermissionApprovalResponse, err error) {
    ...
    c.InitBaseRequest(&request.BaseRequest, "tcsas", APIVersion, "CreateMNGSensitiveAPIPermissionApproval")
    
    if c.GetCredential() == nil {
        return nil, errors.New("CreateMNGSensitiveAPIPermissionApproval require credential")
    }

    request.SetContext(ctx)
    
    response = NewCreateMNGSensitiveAPIPermissionApprovalResponse()
    err = c.Send(request, response)
    return
}
...
func NewCreateMNGVersionRequest() (request *CreateMNGVersionRequest) {
    ...
    request.Init().WithApiInfo("tcsas", APIVersion, "CreateMNGVersion")
    
    
    return
}

func NewCreateMNGVersionResponse() (response *CreateMNGVersionResponse) {
    response = &CreateMNGVersionResponse{
        BaseResponse: &tchttp.BaseResponse{},
    } 
    return
...
func (c *Client) CreateMNGVersion(request *CreateMNGVersionRequest) (response *CreateMNGVersionResponse, err error) {
    return c.CreateMNGVersionWithContext(context.Background(), request)
}
...
//  INVALIDPARAMETERVALUE_INVALIDMNPVERSIONINTRO = "InvalidParameterValue.InvalidMNPVersionIntro"
//  INVALIDPARAMETERVALUE_MNPFILESIZEXCEEDLIMIT = "InvalidParameterValue.MNPFileSizExceedLimit"
func (c *Client) CreateMNGVersionWithContext(ctx context.Context, request *CreateMNGVersionRequest) (response *CreateMNGVersionResponse, err error) {
    if request == nil {
        request = NewCreateMNGVersionRequest()
    }
    c.InitBaseRequest(&request.BaseRequest, "tcsas", APIVersion, "CreateMNGVersion")
    
    if c.GetCredential() == nil {
        return nil, errors.New("CreateMNGVersion require credential")
    }

    request.SetContext(ctx)
    
    response = NewCreateMNGVersionResponse()
    err = c.Send(request, response)
    return
}
...
func NewDeleteMNGRequest() (request *DeleteMNGRequest) {
    request = &DeleteMNGRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    
    request.Init().WithApiInfo("tcsas", APIVersion, "DeleteMNG")
    
    
    return
}

func NewDeleteMNGResponse() (response *DeleteMNGResponse) {
    response = &DeleteMNGResponse{
        BaseResponse: &tchttp.BaseResponse{},
    } 
    return
...
func (c *Client) DeleteMNGWithContext(ctx context.Context, request *DeleteMNGRequest) (response *DeleteMNGResponse, err error) {
    if request == nil {
        request = NewDeleteMNGRequest()
    }
    c.InitBaseRequest(&request.BaseRequest, "tcsas", APIVersion, "DeleteMNG")
    
    if c.GetCredential() == nil {
        return nil, errors.New("DeleteMNG require credential")
    }

    request.SetContext(ctx)
    
    response = NewDeleteMNGResponse()
    err = c.Send(request, response)
    return
}
...
func NewDescribeApplicationMNPListRequest() (request *DescribeApplicationMNPListRequest) {
    request = &DescribeApplicationMNPListRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    
    request.Init().WithApiInfo("tcsas", APIVersion, "DescribeApplicationMNPList")
    
    
    return
}

func NewDescribeApplicationMNPListResponse() (response *DescribeApplicationMNPListResponse) {
    response = &DescribeApplicationMNPListResponse{
        BaseResponse: &tchttp.BaseResponse{},
    } 
    return
...
func (c *Client) DescribeApplicationMNPListWithContext(ctx context.Context, request *DescribeApplicationMNPListRequest) (response *DescribeApplicationMNPListResponse, err error) {
    if request == nil {
        request = NewDescribeApplicationMNPListRequest()
    }
    c.InitBaseRequest(&request.BaseRequest, "tcsas", APIVersion, "DescribeApplicationMNPList")
    
    if c.GetCredential() == nil {
        return nil, errors.New("DescribeApplicationMNPList require credential")
    }

    request.SetContext(ctx)
    
    response = NewDescribeApplicationMNPListResponse()
    err = c.Send(request, response)
    return
}
...
func NewDescribeMNGRequest() (request *DescribeMNGRequest) {
    request = &DescribeMNGRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    
    request.Init().WithApiInfo("tcsas", APIVersion, "DescribeMNG")
    
    
    return
}

func NewDescribeMNGResponse() (response *DescribeMNGResponse) {
    response = &DescribeMNGResponse{
        BaseResponse: &tchttp.BaseResponse{},
    } 
    return
...
func (c *Client) DescribeMNGWithContext(ctx context.Context, request *DescribeMNGRequest) (response *DescribeMNGResponse, err error) {
    if request == nil {
        request = NewDescribeMNGRequest()
    }
    c.InitBaseRequest(&request.BaseRequest, "tcsas", APIVersion, "DescribeMNG")
    
    if c.GetCredential() == nil {
        return nil, errors.New("DescribeMNG require credential")
    }

    request.SetContext(ctx)
    
    response = NewDescribeMNGResponse()
    err = c.Send(request, response)
    return
}
...
func NewDescribeMNGAllStageVersionsRequest() (request *DescribeMNGAllStageVersionsRequest) {
    request = &DescribeMNGAllStageVersionsRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    
    request.Init().WithApiInfo("tcsas", APIVersion, "DescribeMNGAllStageVersions")
    
    
    return
}

func NewDescribeMNGAllStageVersionsResponse() (response *DescribeMNGAllStageVersionsResponse) {
    response = &DescribeMNGAllStageVersionsResponse{
        BaseResponse: &tchttp.BaseResponse{},
    } 
    return
...
func (c *Client) DescribeMNGAllStageVersionsWithContext(ctx context.Context, request *DescribeMNGAllStageVersionsRequest) (response *DescribeMNGAllStageVersionsResponse, err error) {
    if request == nil {
        request = NewDescribeMNGAllStageVersionsRequest()
    }
    c.InitBaseRequest(&request.BaseRequest, "tcsas", APIVersion, "DescribeMNGAllStageVersions")
    
    if c.GetCredential() == nil {
        return nil, errors.New("DescribeMNGAllStageVersions require credential")
    }
...
func NewDescribeMNGCategoryRequest() (request *DescribeMNGCategoryRequest) {
    request = &DescribeMNGCategoryRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    
    request.Init().WithApiInfo("tcsas", APIVersion, "DescribeMNGCategory")
    
    
    return
}

func NewDescribeMNGCategoryResponse() (response *DescribeMNGCategoryResponse) {
    response = &DescribeMNGCategoryResponse{
        BaseResponse: &tchttp.BaseResponse{},
    } 
    return
...
func (c *Client) DescribeMNGCategoryWithContext(ctx context.Context, request *DescribeMNGCategoryRequest) (response *DescribeMNGCategoryResponse, err error) {
    ...
    c.InitBaseRequest(&request.BaseRequest, "tcsas", APIVersion, "DescribeMNGCategory")
    
    if c.GetCredential() == nil {
        return nil, errors.New("DescribeMNGCategory require credential")
    }

    request.SetContext(ctx)
    
    response = NewDescribeMNGCategoryResponse()
    err = c.Send(request, response)
    return
}

func NewDescribeMNGDomainACLRequest() (request *DescribeMNGDomainACLRequest) {
    request = &DescribeMNGDomainACLRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    
    request.Init().WithApiInfo("tcsas", APIVersion, "DescribeMNGDomainACL")
    
    
    return
}

func NewDescribeMNGDomainACLResponse() (response *DescribeMNGDomainACLResponse) {
    response = &DescribeMNGDomainACLResponse{
        BaseResponse: &tchttp.BaseResponse{},
    } 
    return
...
func (c *Client) DescribeMNGDomainACLWithContext(ctx context.Context, request *DescribeMNGDomainACLRequest) (response *DescribeMNGDomainACLResponse, err error) {
    ...
    c.InitBaseRequest(&request.BaseRequest, "tcsas", APIVersion, "DescribeMNGDomainACL")
    
    if c.GetCredential() == nil {
        return nil, errors.New("DescribeMNGDomainACL require credential")
    }

    request.SetContext(ctx)
    
    response = NewDescribeMNGDomainACLResponse()
    err = c.Send(request, response)
    return
}

func NewDescribeMNGListRequest() (request *DescribeMNGListRequest) {
    request = &DescribeMNGListRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    
    request.Init().WithApiInfo("tcsas", APIVersion, "DescribeMNGList")
    
    
    return
}

func NewDescribeMNGListResponse() (response *DescribeMNGListResponse) {
    response = &DescribeMNGListResponse{
        BaseResponse: &tchttp.BaseResponse{},
    } 
    return
...
func (c *Client) DescribeMNGListWithContext(ctx context.Context, request *DescribeMNGListRequest) (response *DescribeMNGListResponse, err error) {
    ...
    c.InitBaseRequest(&request.BaseRequest, "tcsas", APIVersion, "DescribeMNGList")
    
    if c.GetCredential() == nil {
        return nil, errors.New("DescribeMNGList require credential")
    }

    request.SetContext(ctx)
    
    response = NewDescribeMNGListResponse()
    err = c.Send(request, response)
    return
}
...
func NewDescribeMNGOfflinePackageURLRequest() (request *DescribeMNGOfflinePackageURLRequest) {
    request = &DescribeMNGOfflinePackageURLRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    
    request.Init().WithApiInfo("tcsas", APIVersion, "DescribeMNGOfflinePackageURL")
    
    
    return
}

func NewDescribeMNGOfflinePackageURLResponse() (response *DescribeMNGOfflinePackageURLResponse) {
    response = &DescribeMNGOfflinePackageURLResponse{
        BaseResponse: &tchttp.BaseResponse{},
    } 
    return
...
func (c *Client) DescribeMNGOfflinePackageURLWithContext(ctx context.Context, request *DescribeMNGOfflinePackageURLRequest) (response *DescribeMNGOfflinePackageURLResponse, err error) {
    ...
    c.InitBaseRequest(&request.BaseRequest, "tcsas", APIVersion, "DescribeMNGOfflinePackageURL")
    
    if c.GetCredential() == nil {
        return nil, errors.New("DescribeMNGOfflinePackageURL require credential")
    }

    request.SetContext(ctx)
    
    response = NewDescribeMNGOfflinePackageURLResponse()
    err = c.Send(request, response)
    return
}
...
func NewDescribeMNGPreviewRequest() (request *DescribeMNGPreviewRequest) {
    request = &DescribeMNGPreviewRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    
    request.Init().WithApiInfo("tcsas", APIVersion, "DescribeMNGPreview")
    
    
    return
}

func NewDescribeMNGPreviewResponse() (response *DescribeMNGPreviewResponse) {
    response = &DescribeMNGPreviewResponse{
        BaseResponse: &tchttp.BaseResponse{},
    } 
    return
...
func (c *Client) DescribeMNGPreviewWithContext(ctx context.Context, request *DescribeMNGPreviewRequest) (response *DescribeMNGPreviewResponse, err error) {
    if request == nil {
        request = NewDescribeMNGPreviewRequest()
    }
    c.InitBaseRequest(&request.BaseRequest, "tcsas", APIVersion, "DescribeMNGPreview")
    
    if c.GetCredential() == nil {
        return nil, errors.New("DescribeMNGPreview require credential")
    }

    request.SetContext(ctx)
    
    response = NewDescribeMNGPreviewResponse()
    err = c.Send(request, response)
    return
}

func NewDescribeMNGReleasedVersionHistoryRequest() (request *DescribeMNGReleasedVersionHistoryRequest) {
    request = &DescribeMNGReleasedVersionHistoryRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    
    request.Init().WithApiInfo("tcsas", APIVersion, "DescribeMNGReleasedVersionHistory")
    
    
    return
}

func NewDescribeMNGReleasedVersionHistoryResponse() (response *DescribeMNGReleasedVersionHistoryResponse) {
    response = &DescribeMNGReleasedVersionHistoryResponse{
        BaseResponse: &tchttp.BaseResponse{},
    } 
    return
...
func (c *Client) DescribeMNGReleasedVersionHistoryWithContext(ctx context.Context, request *DescribeMNGReleasedVersionHistoryRequest) (response *DescribeMNGReleasedVersionHistoryResponse, err error) {
    if request == nil {
        request = NewDescribeMNGReleasedVersionHistoryRequest()
    }
    c.InitBaseRequest(&request.BaseRequest, "tcsas", APIVersion, "DescribeMNGReleasedVersionHistory")
    
    if c.GetCredential() == nil {
        return nil, errors.New("DescribeMNGReleasedVersionHistory require credential")
    }

    request.SetContext(ctx)
    
    response = NewDescribeMNGReleasedVersionHistoryResponse()
    err = c.Send(request, response)
    return
}
...
func NewDescribeMNGSensitiveAPIPermissionApprovalRequest() (request *DescribeMNGSensitiveAPIPermissionApprovalRequest) {
    request = &DescribeMNGSensitiveAPIPermissionApprovalRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    
    request.Init().WithApiInfo("tcsas", APIVersion, "DescribeMNGSensitiveAPIPermissionApproval")
    
    
    return
}

func NewDescribeMNGSensitiveAPIPermissionApprovalResponse() (response *DescribeMNGSensitiveAPIPermissionApprovalResponse) {
    response = &DescribeMNGSensitiveAPIPermissionApprovalResponse{
        BaseResponse: &tchttp.BaseResponse{},
    } 
    return
...
func (c *Client) DescribeMNGSensitiveAPIPermissionApprovalWithContext(ctx context.Context, request *DescribeMNGSensitiveAPIPermissionApprovalRequest) (response *DescribeMNGSensitiveAPIPermissionApprovalResponse, err error) {
    ...
    c.InitBaseRequest(&request.BaseRequest, "tcsas", APIVersion, "DescribeMNGSensitiveAPIPermissionApproval")
    
    if c.GetCredential() == nil {
        return nil, errors.New("DescribeMNGSensitiveAPIPermissionApproval require credential")
    }

    request.SetContext(ctx)
    
    response = NewDescribeMNGSensitiveAPIPermissionApprovalResponse()
    err = c.Send(request, response)
    return
}

func NewDescribeMNGSensitiveAPIPermissionListRequest() (request *DescribeMNGSensitiveAPIPermissionListRequest) {
    request = &DescribeMNGSensitiveAPIPermissionListRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    
    request.Init().WithApiInfo("tcsas", APIVersion, "DescribeMNGSensitiveAPIPermissionList")
    
    
    return
}

func NewDescribeMNGSensitiveAPIPermissionListResponse() (response *DescribeMNGSensitiveAPIPermissionListResponse) {
    response = &DescribeMNGSensitiveAPIPermissionListResponse{
        BaseResponse: &tchttp.BaseResponse{},
    } 
    return
...
func (c *Client) DescribeMNGSensitiveAPIPermissionListWithContext(ctx context.Context, request *DescribeMNGSensitiveAPIPermissionListRequest) (response *DescribeMNGSensitiveAPIPermissionListResponse, err error) {
    if request == nil {
        request = NewDescribeMNGSensitiveAPIPermissionListRequest()
    }
    c.InitBaseRequest(&request.BaseRequest, "tcsas", APIVersion, "DescribeMNGSensitiveAPIPermissionList")
    
    if c.GetCredential() == nil {
        return nil, errors.New("DescribeMNGSensitiveAPIPermissionList require credential")
    }

    request.SetContext(ctx)
    
    response = NewDescribeMNGSensitiveAPIPermissionListResponse()
    err = c.Send(request, response)
    return
}
...
func NewDescribeMNGVersionRequest() (request *DescribeMNGVersionRequest) {
    ...
    request.Init().WithApiInfo("tcsas", APIVersion, "DescribeMNGVersion")
    
    
    return
}

func NewDescribeMNGVersionResponse() (response *DescribeMNGVersionResponse) {
    response = &DescribeMNGVersionResponse{
        BaseResponse: &tchttp.BaseResponse{},
    } 
    return
...
func (c *Client) DescribeMNGVersionWithContext(ctx context.Context, request *DescribeMNGVersionRequest) (response *DescribeMNGVersionResponse, err error) {
    if request == nil {
        request = NewDescribeMNGVersionRequest()
    }
    c.InitBaseRequest(&request.BaseRequest, "tcsas", APIVersion, "DescribeMNGVersion")
    
    if c.GetCredential() == nil {
        return nil, errors.New("DescribeMNGVersion require credential")
    }

    request.SetContext(ctx)
    
    response = NewDescribeMNGVersionResponse()
    err = c.Send(request, response)
    return
}
...
func NewModifyMNGRequest() (request *ModifyMNGRequest) {
    request = &ModifyMNGRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    
    request.Init().WithApiInfo("tcsas", APIVersion, "ModifyMNG")
    
    
    return
}

func NewModifyMNGResponse() (response *ModifyMNGResponse) {
    response = &ModifyMNGResponse{
        BaseResponse: &tchttp.BaseResponse{},
    } 
    return
...
//  INVALIDPARAMETERVALUE_MNPTYPENUMBEREXCEEDLIMIT = "InvalidParameterValue.MNPTypeNumberExceedLimit"
//  INVALIDPARAMETERVALUE_MINIPROGRAMNAMEALREADYEXIST = "InvalidParameterValue.MiniProgramNameAlreadyExist"
func (c *Client) ModifyMNG(request *ModifyMNGRequest) (response *ModifyMNGResponse, err error) {
    return c.ModifyMNGWithContext(context.Background(), request)
}
...
//  INVALIDPARAMETERVALUE_MNPTYPENUMBEREXCEEDLIMIT = "InvalidParameterValue.MNPTypeNumberExceedLimit"
//  INVALIDPARAMETERVALUE_MINIPROGRAMNAMEALREADYEXIST = "InvalidParameterValue.MiniProgramNameAlreadyExist"
func (c *Client) ModifyMNGWithContext(ctx context.Context, request *ModifyMNGRequest) (response *ModifyMNGResponse, err error) {
    if request == nil {
        request = NewModifyMNGRequest()
    }
    c.InitBaseRequest(&request.BaseRequest, "tcsas", APIVersion, "ModifyMNG")
    
    if c.GetCredential() == nil {
        return nil, errors.New("ModifyMNG require credential")
    }

    request.SetContext(ctx)
    
    response = NewModifyMNGResponse()
    err = c.Send(request, response)
    return
}
...
func NewModifyMNGDomainRequest() (request *ModifyMNGDomainRequest) {
    ...
    request.Init().WithApiInfo("tcsas", APIVersion, "ModifyMNGDomain")
    
    
    return
}

func NewModifyMNGDomainResponse() (response *ModifyMNGDomainResponse) {
    response = &ModifyMNGDomainResponse{
        BaseResponse: &tchttp.BaseResponse{},
    } 
    return
...
func (c *Client) ModifyMNGDomainWithContext(ctx context.Context, request *ModifyMNGDomainRequest) (response *ModifyMNGDomainResponse, err error) {
    if request == nil {
        request = NewModifyMNGDomainRequest()
    }
    c.InitBaseRequest(&request.BaseRequest, "tcsas", APIVersion, "ModifyMNGDomain")
    
    if c.GetCredential() == nil {
        return nil, errors.New("ModifyMNGDomain require credential")
    }

    request.SetContext(ctx)
    
    response = NewModifyMNGDomainResponse()
    err = c.Send(request, response)
    return
}
...
func NewReleaseMNGVersionRequest() (request *ReleaseMNGVersionRequest) {
    request = &ReleaseMNGVersionRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    
    request.Init().WithApiInfo("tcsas", APIVersion, "ReleaseMNGVersion")
    
    
    return
}

func NewReleaseMNGVersionResponse() (response *ReleaseMNGVersionResponse) {
    response = &ReleaseMNGVersionResponse{
        BaseResponse: &tchttp.BaseResponse{},
    } 
    return
...
func (c *Client) ReleaseMNGVersionWithContext(ctx context.Context, request *ReleaseMNGVersionRequest) (response *ReleaseMNGVersionResponse, err error) {
    if request == nil {
        request = NewReleaseMNGVersionRequest()
    }
    c.InitBaseRequest(&request.BaseRequest, "tcsas", APIVersion, "ReleaseMNGVersion")
    
    if c.GetCredential() == nil {
        return nil, errors.New("ReleaseMNGVersion require credential")
    }

    request.SetContext(ctx)
    
    response = NewReleaseMNGVersionResponse()
    err = c.Send(request, response)
    return
}
...
func NewRemoveMNGRequest() (request *RemoveMNGRequest) {
    request = &RemoveMNGRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    
    request.Init().WithApiInfo("tcsas", APIVersion, "RemoveMNG")
    
    
    return
}

func NewRemoveMNGResponse() (response *RemoveMNGResponse) {
    response = &RemoveMNGResponse{
        BaseResponse: &tchttp.BaseResponse{},
    } 
    return
...
func (c *Client) RemoveMNGWithContext(ctx context.Context, request *RemoveMNGRequest) (response *RemoveMNGResponse, err error) {
    if request == nil {
        request = NewRemoveMNGRequest()
    }
    c.InitBaseRequest(&request.BaseRequest, "tcsas", APIVersion, "RemoveMNG")
    
    if c.GetCredential() == nil {
        return nil, errors.New("RemoveMNG require credential")
    }

    request.SetContext(ctx)
    
    response = NewRemoveMNGResponse()
    err = c.Send(request, response)
    return
}
...
func NewRollbackMNGVersionRequest() (request *RollbackMNGVersionRequest) {
    request = &RollbackMNGVersionRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    
    request.Init().WithApiInfo("tcsas", APIVersion, "RollbackMNGVersion")
    
    
    return
}

func NewRollbackMNGVersionResponse() (response *RollbackMNGVersionResponse) {
    response = &RollbackMNGVersionResponse{
        BaseResponse: &tchttp.BaseResponse{},
    } 
    return
...
func (c *Client) RollbackMNGVersionWithContext(ctx context.Context, request *RollbackMNGVersionRequest) (response *RollbackMNGVersionResponse, err error) {
    if request == nil {
        request = NewRollbackMNGVersionRequest()
    }
    c.InitBaseRequest(&request.BaseRequest, "tcsas", APIVersion, "RollbackMNGVersion")
    
    if c.GetCredential() == nil {
        return nil, errors.New("RollbackMNGVersion require credential")
    }

    request.SetContext(ctx)
    
    response = NewRollbackMNGVersionResponse()
    err = c.Send(request, response)
    return
}
