...
type AllocateHostsRequestParams struct {
	...
	HostChargePrepaid *ChargePrepaid `json:"HostChargePrepaid,omitnil" name:"HostChargePrepaid"`

	// Instance billing model, only monthly or yearly subscription supported. Default value: `PREPAID'.
	HostChargeType *string `json:"HostChargeType,omitnil" name:"HostChargeType"`
...
type ChcHost struct {
	// CHC host ID
	ChcId *string `json:"ChcId,omitnil" name:"ChcId"`
	...
	// Out-of-band network
	// Note: This field may return `null`, indicating that no valid values can be obtained.
	BmcVirtualPrivateCloud *VirtualPrivateCloud `json:"BmcVirtualPrivateCloud,omitnil" name:"BmcVirtualPrivateCloud"`

	// Out-of-band network IP
	// Note: This field may return `null`, indicating that no valid values can be obtained.
	BmcIp *string `json:"BmcIp,omitnil" name:"BmcIp"`

	// Out-of-band network security group ID
	// Note: This field may return `null`, indicating that no valid values can be obtained.
	BmcSecurityGroupIds []*string `json:"BmcSecurityGroupIds,omitnil" name:"BmcSecurityGroupIds"`

	// Deployment network
	// Note: This field may return `null`, indicating that no valid values can be obtained.
	DeployVirtualPrivateCloud *VirtualPrivateCloud `json:"DeployVirtualPrivateCloud,omitnil" name:"DeployVirtualPrivateCloud"`

	// Deployment network IP
	// Note: This field may return `null`, indicating that no valid values can be obtained.
	DeployIp *string `json:"DeployIp,omitnil" name:"DeployIp"`

	// Deployment network security group ID
	// Note: This field may return `null`, indicating that no valid values can be obtained.
	DeploySecurityGroupIds []*string `json:"DeploySecurityGroupIds,omitnil" name:"DeploySecurityGroupIds"`
	...
	// Note: This field may return `null`, indicating that no valid values can be obtained.
	HardwareDescription *string `json:"HardwareDescription,omitnil" name:"HardwareDescription"`
	...
	// Note: This field may return `null`, indicating that no valid values can be obtained.
	Disk *string `json:"Disk,omitnil" name:"Disk"`

	// MAC address assigned under the out-of-band network
	// Note: This field may return `null`, indicating that no valid values can be obtained.
	BmcMAC *string `json:"BmcMAC,omitnil" name:"BmcMAC"`

	// MAC address assigned under the deployment network
	// Note: This field may return `null`, indicating that no valid values can be obtained.
	DeployMAC *string `json:"DeployMAC,omitnil" name:"DeployMAC"`

	// Management type
	// HOSTING: Hosting
	// TENANT: Leasing
	// Note: This field may return `null`, indicating that no valid values can be obtained.
	TenantType *string `json:"TenantType,omitnil" name:"TenantType"`

	// CHC DHCP option, which is used for MiniOS debugging.
	// Note: This field may return `null`, indicating that no valid values can be obtained.
	DeployExtraConfig *ChcDeployExtraConfig `json:"DeployExtraConfig,omitnil" name:"DeployExtraConfig"`
}
...
type ChcHostDeniedActions struct {
	...
	DenyActions []*string `json:"DenyActions,omitnil" name:"DenyActions"`
}

// Predefined struct for user
type ConfigureChcAssistVpcRequestParams struct {
	// CHC host IDs
	ChcIds []*string `json:"ChcIds,omitnil" name:"ChcIds"`
...
type CreateDisasterRecoverGroupResponseParams struct {
	...
	DisasterRecoverGroupId *string `json:"DisasterRecoverGroupId,omitnil" name:"DisasterRecoverGroupId"`
	...
	CvmQuotaTotal *int64 `json:"CvmQuotaTotal,omitnil" name:"CvmQuotaTotal"`
...
type CreateImageRequestParams struct {
	...
	DataDiskIds []*string `json:"DataDiskIds,omitnil" name:"DataDiskIds"`
...
type CreateLaunchTemplateVersionRequestParams struct {
	...
	LaunchTemplateId *string `json:"LaunchTemplateId,omitnil" name:"LaunchTemplateId"`
	...
	LaunchTemplateVersion *int64 `json:"LaunchTemplateVersion,omitnil" name:"LaunchTemplateVersion"`

	// Description of instance launch template versions. This parameter can contain 2-256 characters.
	LaunchTemplateVersionDescription *string `json:"LaunchTemplateVersionDescription,omitnil" name:"LaunchTemplateVersionDescription"`
...
type CreateLaunchTemplateVersionResponseParams struct {
	...
	LaunchTemplateVersionNumber *int64 `json:"LaunchTemplateVersionNumber,omitnil" name:"LaunchTemplateVersionNumber"`
...
type DeleteImagesRequestParams struct {
	...
	DeleteBindedSnap *bool `json:"DeleteBindedSnap,omitnil" name:"DeleteBindedSnap"`
...
type DeleteLaunchTemplateVersionsRequestParams struct {
	...
	LaunchTemplateVersions []*int64 `json:"LaunchTemplateVersions,omitnil" name:"LaunchTemplateVersions"`
}
...
type DescribeChcDeniedActionsResponseParams struct {
	...
	ChcHostDeniedActionSet []*ChcHostDeniedActions `json:"ChcHostDeniedActionSet,omitnil" name:"ChcHostDeniedActionSet"`
...
type DescribeChcHostsResponseParams struct {
	...
	ChcHostSet []*ChcHost `json:"ChcHostSet,omitnil" name:"ChcHostSet"`
...
type DescribeDisasterRecoverGroupQuotaResponseParams struct {
	...
	GroupQuota *int64 `json:"GroupQuota,omitnil" name:"GroupQuota"`
	...
	CvmInHostGroupQuota *int64 `json:"CvmInHostGroupQuota,omitnil" name:"CvmInHostGroupQuota"`

	// Quota on instances in a switch-type disaster recovery group.
	CvmInSwGroupQuota *int64 `json:"CvmInSwGroupQuota,omitnil" name:"CvmInSwGroupQuota"`

	// Quota on instances in a rack-type disaster recovery group.
	CvmInRackGroupQuota *int64 `json:"CvmInRackGroupQuota,omitnil" name:"CvmInRackGroupQuota"`
...
type DescribeDisasterRecoverGroupsResponseParams struct {
	...
	DisasterRecoverGroupSet []*DisasterRecoverGroup `json:"DisasterRecoverGroupSet,omitnil" name:"DisasterRecoverGroupSet"`
...
type DescribeHostsResponseParams struct {
	...
	HostSet []*HostItem `json:"HostSet,omitnil" name:"HostSet"`
...
type DescribeImageQuotaResponseParams struct {
	...
	ImageNumQuota *int64 `json:"ImageNumQuota,omitnil" name:"ImageNumQuota"`
...
type DescribeImageSharePermissionResponseParams struct {
	...
	SharePermissionSet []*SharePermission `json:"SharePermissionSet,omitnil" name:"SharePermissionSet"`
...
type DescribeInstanceFamilyConfigsResponseParams struct {
	...
	InstanceFamilyConfigSet []*InstanceFamilyConfig `json:"InstanceFamilyConfigSet,omitnil" name:"InstanceFamilyConfigSet"`
...
type DescribeInstancesOperationLimitResponseParams struct {
	...
	InstanceOperationLimitSet []*OperationCountLimit `json:"InstanceOperationLimitSet,omitnil" name:"InstanceOperationLimitSet"`
...
type DescribeInstancesStatusResponseParams struct {
	...
	InstanceStatusSet []*InstanceStatus `json:"InstanceStatusSet,omitnil" name:"InstanceStatusSet"`
...
type DescribeInternetChargeTypeConfigsResponseParams struct {
	...
	InternetChargeTypeConfigSet []*InternetChargeTypeConfig `json:"InternetChargeTypeConfigSet,omitnil" name:"InternetChargeTypeConfigSet"`
...
type DescribeLaunchTemplateVersionsRequestParams struct {
	...
	LaunchTemplateVersions []*uint64 `json:"LaunchTemplateVersions,omitnil" name:"LaunchTemplateVersions"`

	// The minimum version number specified, which defaults to 0.
	MinVersion *uint64 `json:"MinVersion,omitnil" name:"MinVersion"`

	// The maximum version number specified, which defaults to 30.
	MaxVersion *uint64 `json:"MaxVersion,omitnil" name:"MaxVersion"`
	...
	DefaultVersion *bool `json:"DefaultVersion,omitnil" name:"DefaultVersion"`
}
...
type DescribeLaunchTemplateVersionsResponseParams struct {
	...
	LaunchTemplateVersionSet []*LaunchTemplateVersionInfo `json:"LaunchTemplateVersionSet,omitnil" name:"LaunchTemplateVersionSet"`
...
type DescribeLaunchTemplatesRequestParams struct {
	...
	LaunchTemplateIds []*string `json:"LaunchTemplateIds,omitnil" name:"LaunchTemplateIds"`
...
type DescribeLaunchTemplatesResponseParams struct {
	...
	// Note: This field may return `null`, indicating that no valid values can be obtained.
	LaunchTemplateSet []*LaunchTemplateInfo `json:"LaunchTemplateSet,omitnil" name:"LaunchTemplateSet"`
...
type DescribeReservedInstancesConfigInfosResponseParams struct {
	...
	ReservedInstanceConfigInfos []*ReservedInstanceConfigInfoItem `json:"ReservedInstanceConfigInfos,omitnil" name:"ReservedInstanceConfigInfos"`
...
type DescribeReservedInstancesOfferingsRequestParams struct {
	...
	MaxDuration *int64 `json:"MaxDuration,omitnil" name:"MaxDuration"`

	// The minimum duration as a filter, 
	// in seconds.
	// Default value: 2592000.
	MinDuration *int64 `json:"MinDuration,omitnil" name:"MinDuration"`
...
type DescribeReservedInstancesOfferingsResponseParams struct {
	...
	ReservedInstancesOfferingsSet []*ReservedInstancesOffering `json:"ReservedInstancesOfferingsSet,omitnil" name:"ReservedInstancesOfferingsSet"`
...
type ExportImagesRequestParams struct {
	...
	ExportFormat *string `json:"ExportFormat,omitnil" name:"ExportFormat"`

	// Prefix list of the name of exported files
	FileNamePrefixList []*string `json:"FileNamePrefixList,omitnil" name:"FileNamePrefixList"`

	// Whether to export only the system disk
	OnlyExportRootDisk *bool `json:"OnlyExportRootDisk,omitnil" name:"OnlyExportRootDisk"`
...
type ExportImagesResponseParams struct {
	...
	CosPaths []*string `json:"CosPaths,omitnil" name:"CosPaths"`
...
type GPUInfo struct {
	...
	// GPU address
	// Note: this field may return `null`, indicating that no valid value can be found.
	GPUId []*string `json:"GPUId,omitnil" name:"GPUId"`
...
type HostItem struct {
	...
	// CDH instance status
	HostState *string `json:"HostState,omitnil" name:"HostState"`

	// CDH instance IP
	HostIp *string `json:"HostIp,omitnil" name:"HostIp"`

	// CDH instance resource information
	HostResource *HostResource `json:"HostResource,omitnil" name:"HostResource"`
...
type HostResource struct {
	...
	GpuTotal *uint64 `json:"GpuTotal,omitnil" name:"GpuTotal"`

	// Number of available GPU cards in the CDH instance
	GpuAvailable *uint64 `json:"GpuAvailable,omitnil" name:"GpuAvailable"`
}
...
type Image struct {
	...
	// Image creator
	ImageCreator *string `json:"ImageCreator,omitnil" name:"ImageCreator"`
	...
	// Note: This field may return null, indicating that no valid value is found.
	SyncPercent *int64 `json:"SyncPercent,omitnil" name:"SyncPercent"`
...
type ImportImageRequestParams struct {
	...
	// Boot mode
	BootMode *string `json:"BootMode,omitnil" name:"BootMode"`
}
...
type InquirePricePurchaseReservedInstancesOfferingRequestParams struct {
	...
	ReservedInstancesOfferingId *string `json:"ReservedInstancesOfferingId,omitnil" name:"ReservedInstancesOfferingId"`
...
type InquirePricePurchaseReservedInstancesOfferingResponseParams struct {
	...
	Price *ReservedInstancePrice `json:"Price,omitnil" name:"Price"`
...
type Instance struct {
	...
	StopChargingMode *string `json:"StopChargingMode,omitnil" name:"StopChargingMode"`
	...
	// Note: this field may return null, indicating that no valid value was found.
	RdmaIpAddresses []*string `json:"RdmaIpAddresses,omitnil" name:"RdmaIpAddresses"`
	...
	// Note: this field may return null, indicating that no valid value was found.
	IsolatedSource *string `json:"IsolatedSource,omitnil" name:"IsolatedSource"`

	// GPU information. This field is only returned for GPU instances.
	// Note: this field may return null, indicating that no valid value was found.
	GPUInfo *GPUInfo `json:"GPUInfo,omitnil" name:"GPUInfo"`
	...
	// Default login user
	DefaultLoginUser *string `json:"DefaultLoginUser,omitnil" name:"DefaultLoginUser"`

	// Default login port
	DefaultLoginPort *int64 `json:"DefaultLoginPort,omitnil" name:"DefaultLoginPort"`

	// Latest operation errors of the instance.
	// Note: This field may return `null`, indicating that no valid values can be obtained.
	LatestOperationErrorMsg *string `json:"LatestOperationErrorMsg,omitnil" name:"LatestOperationErrorMsg"`
}
...
type LaunchTemplate struct {
	...
	LaunchTemplateVersion *uint64 `json:"LaunchTemplateVersion,omitnil" name:"LaunchTemplateVersion"`
}

type LaunchTemplateInfo struct {
	// Instance launch template version number.
	// Note: This field may return `null`, indicating that no valid values can be obtained.
	LatestVersionNumber *uint64 `json:"LatestVersionNumber,omitnil" name:"LatestVersionNumber"`
	...
	// Note: This field may return `null`, indicating that no valid values can be obtained.
	LaunchTemplateName *string `json:"LaunchTemplateName,omitnil" name:"LaunchTemplateName"`

	// Default instance launch template version number.
	// Note: This field may return `null`, indicating that no valid values can be obtained.
	DefaultVersionNumber *uint64 `json:"DefaultVersionNumber,omitnil" name:"DefaultVersionNumber"`

	// Total number of versions that the instance launch template contains.
	// Note: This field may return `null`, indicating that no valid values can be obtained.
	LaunchTemplateVersionCount *uint64 `json:"LaunchTemplateVersionCount,omitnil" name:"LaunchTemplateVersionCount"`
...
type LaunchTemplateVersionInfo struct {
	...
	LaunchTemplateVersionData *LaunchTemplateVersionData `json:"LaunchTemplateVersionData,omitnil" name:"LaunchTemplateVersionData"`
	...
	IsDefaultVersion *bool `json:"IsDefaultVersion,omitnil" name:"IsDefaultVersion"`
...
type ModifyChcAttributeRequestParams struct {
	...
	BmcUser *string `json:"BmcUser,omitnil" name:"BmcUser"`
...
type ModifyInstancesAttributeRequestParams struct {
	...
	CamRoleType *string `json:"CamRoleType,omitnil" name:"CamRoleType"`
}
...
type ModifyInstancesVpcAttributeRequestParams struct {
	...
	ReserveHostName *bool `json:"ReserveHostName,omitnil" name:"ReserveHostName"`
}
...
type ModifyLaunchTemplateDefaultVersionRequestParams struct {
	...
	DefaultVersion *int64 `json:"DefaultVersion,omitnil" name:"DefaultVersion"`
}
...
type OperationCountLimit struct {
	...
	CurrentCount *int64 `json:"CurrentCount,omitnil" name:"CurrentCount"`
	...
	LimitCount *int64 `json:"LimitCount,omitnil" name:"LimitCount"`
}
...
type ReservedInstanceConfigInfoItem struct {
	...
	InstanceFamilies []*ReservedInstanceFamilyItem `json:"InstanceFamilies,omitnil" name:"InstanceFamilies"`
}
...
type ReservedInstanceFamilyItem struct {
	...
	InstanceTypes []*ReservedInstanceTypeItem `json:"InstanceTypes,omitnil" name:"InstanceTypes"`
}

type ReservedInstancePrice struct {
	// Original upfront payment, in USD.
	OriginalFixedPrice *float64 `json:"OriginalFixedPrice,omitnil" name:"OriginalFixedPrice"`

	// Discounted upfront payment, in USD.
	DiscountFixedPrice *float64 `json:"DiscountFixedPrice,omitnil" name:"DiscountFixedPrice"`

	// Original subsequent unit price, in USD/hr.
	OriginalUsagePrice *float64 `json:"OriginalUsagePrice,omitnil" name:"OriginalUsagePrice"`

	// Discounted subsequent unit price, in USD/hr.
	DiscountUsagePrice *float64 `json:"DiscountUsagePrice,omitnil" name:"DiscountUsagePrice"`
}

type ReservedInstancePriceItem struct {
	// Payment method. Valid values: All Upfront, Partial Upfront, and No Upfront.
	OfferingType *string `json:"OfferingType,omitnil" name:"OfferingType"`

	// Upfront payment, in USD.
	FixedPrice *float64 `json:"FixedPrice,omitnil" name:"FixedPrice"`

	// Subsequent unit price, in USD/hr.
	UsagePrice *float64 `json:"UsagePrice,omitnil" name:"UsagePrice"`
...
type ReservedInstanceTypeItem struct {
	...
	// Number of FPGAs.
	Fpga *uint64 `json:"Fpga,omitnil" name:"Fpga"`

	// Number of local storage blocks.
	StorageBlock *uint64 `json:"StorageBlock,omitnil" name:"StorageBlock"`

	// Number of NICs.
	NetworkCard *uint64 `json:"NetworkCard,omitnil" name:"NetworkCard"`

	// Maximum bandwidth.
	MaxBandwidth *float64 `json:"MaxBandwidth,omitnil" name:"MaxBandwidth"`
	...
	Prices []*ReservedInstancePriceItem `json:"Prices,omitnil" name:"Prices"`
}
...
type ResizeInstanceDisksRequestParams struct {
	...
	ResizeOnline *bool `json:"ResizeOnline,omitnil" name:"ResizeOnline"`
}
...
type RunInstancesRequestParams struct {
	...
	LaunchTemplate *LaunchTemplate `json:"LaunchTemplate,omitnil" name:"LaunchTemplate"`
...
type SyncImagesRequestParams struct {
	...
	DestinationRegions []*string `json:"DestinationRegions,omitnil" name:"DestinationRegions"`
	...
	ImageSetRequired *bool `json:"ImageSetRequired,omitnil" name:"ImageSetRequired"`
}
...
type SyncImagesResponseParams struct {
	...
	ImageSet []*SyncImage `json:"ImageSet,omitnil" name:"ImageSet"`
...
type TerminateInstancesRequestParams struct {
	...
	ReleasePrepaidDataDisks *bool `json:"ReleasePrepaidDataDisks,omitnil" name:"ReleasePrepaidDataDisks"`
}
