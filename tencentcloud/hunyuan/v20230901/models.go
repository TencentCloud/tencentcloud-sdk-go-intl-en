...
// Predefined struct for user
type DescribeAutoRiggingJobRequestParams struct {
	// Task ID (valid period: 24 hours).
	JobId *string `json:"JobId,omitnil,omitempty" name:"JobId"`
}

type DescribeAutoRiggingJobRequest struct {
	*tchttp.BaseRequest
...
func (r *DescribeAutoRiggingJobRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeAutoRiggingJobRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	delete(f, "JobId")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DescribeAutoRiggingJobRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DescribeAutoRiggingJobResponseParams struct {
	// Task status:
	// WAIT: waiting;
	// RUN: running;
	// FAIL: failed;
...
type DescribeAutoRiggingJobResponse struct {
	*tchttp.BaseResponse
	Response *DescribeAutoRiggingJobResponseParams `json:"Response"`
}

func (r *DescribeAutoRiggingJobResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeAutoRiggingJobResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DescribeConvert3DFormatJobRequestParams struct {
	// Task ID (valid period: 24 hours).
	JobId *string `json:"JobId,omitnil,omitempty" name:"JobId"`
}

type DescribeConvert3DFormatJobRequest struct {
	*tchttp.BaseRequest
...
func (r *DescribeConvert3DFormatJobRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeConvert3DFormatJobRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	delete(f, "JobId")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DescribeConvert3DFormatJobRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DescribeConvert3DFormatJobResponseParams struct {
	// Task status:
	// WAIT: waiting;
	// RUN: running;
	// FAIL: failed;
...
type DescribeConvert3DFormatJobResponse struct {
	*tchttp.BaseResponse
	Response *DescribeConvert3DFormatJobResponseParams `json:"Response"`
}

func (r *DescribeConvert3DFormatJobResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeConvert3DFormatJobResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
// Predefined struct for user
type SubmitAutoRiggingJobRequestParams struct {
	...
	MotionType *int64 `json:"MotionType,omitnil,omitempty" name:"MotionType"`
}

type SubmitAutoRiggingJobRequest struct {
	*tchttp.BaseRequest
...
func (r *SubmitAutoRiggingJobRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *SubmitAutoRiggingJobRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "MotionType")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "SubmitAutoRiggingJobRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type SubmitAutoRiggingJobResponseParams struct {
	// Task ID (valid period: 24 hours).
	JobId *string `json:"JobId,omitnil,omitempty" name:"JobId"`
...
type SubmitAutoRiggingJobResponse struct {
	*tchttp.BaseResponse
	Response *SubmitAutoRiggingJobResponseParams `json:"Response"`
}

func (r *SubmitAutoRiggingJobResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *SubmitAutoRiggingJobResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type SubmitConvert3DFormatJobRequestParams struct {
...
type SubmitConvert3DFormatJobRequest struct {
	*tchttp.BaseRequest
...
func (r *SubmitConvert3DFormatJobRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *SubmitConvert3DFormatJobRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "Format")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "SubmitConvert3DFormatJobRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type SubmitConvert3DFormatJobResponseParams struct {
	// Task ID.
	JobId *string `json:"JobId,omitnil,omitempty" name:"JobId"`
...
type SubmitConvert3DFormatJobResponse struct {
	*tchttp.BaseResponse
	Response *SubmitConvert3DFormatJobResponseParams `json:"Response"`
}

func (r *SubmitConvert3DFormatJobResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *SubmitConvert3DFormatJobResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
