...
type MixLayoutParams struct {
	...
	PureAudioDisableLayout *bool `json:"PureAudioDisableLayout,omitnil,omitempty" name:"PureAudioDisableLayout"`
}
...
// Predefined struct for user
type QueryAIMessageListRequestParams struct {
...
type QueryAIMessageListRequest struct {
	*tchttp.BaseRequest
...
func (r *QueryAIMessageListRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *QueryAIMessageListRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "TaskId")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "QueryAIMessageListRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type QueryAIMessageListResponseParams struct {
	// Total number of AI conversation context messages.
	Total *uint64 `json:"Total,omitnil,omitempty" name:"Total"`

	// List of AI conversation context information.
	MessageList []*MessageInfo `json:"MessageList,omitnil,omitempty" name:"MessageList"`

	// The unique request ID, generated by the server, will be returned for every request (if the request fails to reach the server for other reasons, the request will not obtain a RequestId). RequestId is required for locating a problem.
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type QueryAIMessageListResponse struct {
	*tchttp.BaseResponse
	Response *QueryAIMessageListResponseParams `json:"Response"`
}

func (r *QueryAIMessageListResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *QueryAIMessageListResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type RecordParams struct {
	...
	SubscribeAbility *uint64 `json:"SubscribeAbility,omitnil,omitempty" name:"SubscribeAbility"`
}
