...
type ApplySdkVerificationTokenRequestParams struct {
	...
	SkipLaunchPage *bool `json:"SkipLaunchPage,omitnil,omitempty" name:"SkipLaunchPage"`
	...
	SkipOcrConfirmPage *bool `json:"SkipOcrConfirmPage,omitnil,omitempty" name:"SkipOcrConfirmPage"`
	...
	HideProgressBar *bool `json:"HideProgressBar,omitnil,omitempty" name:"HideProgressBar"`
