...
func NewGetNFCResultRequest() (request *GetNFCResultRequest) {
    request = &GetNFCResultRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    
    request.Init().WithApiInfo("faceid", APIVersion, "GetNFCResult")
    
    
    return
}

func NewGetNFCResultResponse() (response *GetNFCResultResponse) {
    response = &GetNFCResultResponse{
        BaseResponse: &tchttp.BaseResponse{},
    } 
    return
...
//  INVALIDPARAMETER = "InvalidParameter"
//  INVALIDPARAMETERVALUE = "InvalidParameterValue"
func (c *Client) GetNFCResult(request *GetNFCResultRequest) (response *GetNFCResultResponse, err error) {
    return c.GetNFCResultWithContext(context.Background(), request)
}
...
//  INVALIDPARAMETER = "InvalidParameter"
//  INVALIDPARAMETERVALUE = "InvalidParameterValue"
func (c *Client) GetNFCResultWithContext(ctx context.Context, request *GetNFCResultRequest) (response *GetNFCResultResponse, err error) {
    if request == nil {
        request = NewGetNFCResultRequest()
    }
    c.InitBaseRequest(&request.BaseRequest, "faceid", APIVersion, "GetNFCResult")
    
    if c.GetCredential() == nil {
        return nil, errors.New("GetNFCResult require credential")
    }

    request.SetContext(ctx)
    
    response = NewGetNFCResultResponse()
    err = c.Send(request, response)
    return
}
