...
// Predefined struct for user
type DescribeCustomerOwnVoucherUsageDetailsRequestParams struct {
...
type DescribeCustomerOwnVoucherUsageDetailsRequest struct {
	*tchttp.BaseRequest
...
func (r *DescribeCustomerOwnVoucherUsageDetailsRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeCustomerOwnVoucherUsageDetailsRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "Month")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DescribeCustomerOwnVoucherUsageDetailsRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DescribeCustomerOwnVoucherUsageDetailsResponseParams struct {
	// Voucher information details
	Data []*UsageDetail `json:"Data,omitnil,omitempty" name:"Data"`
	...
	TotalRecordsCount *int64 `json:"TotalRecordsCount,omitnil,omitempty" name:"TotalRecordsCount"`

	// Voucher Usage Month
	Month *string `json:"Month,omitnil,omitempty" name:"Month"`

	// Number of records in the current month
	RecordsCountByMonth *int64 `json:"RecordsCountByMonth,omitnil,omitempty" name:"RecordsCountByMonth"`

	// The unique request ID, generated by the server, will be returned for every request (if the request fails to reach the server for other reasons, the request will not obtain a RequestId). RequestId is required for locating a problem.
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type DescribeCustomerOwnVoucherUsageDetailsResponse struct {
	*tchttp.BaseResponse
	Response *DescribeCustomerOwnVoucherUsageDetailsResponseParams `json:"Response"`
}

func (r *DescribeCustomerOwnVoucherUsageDetailsResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeCustomerOwnVoucherUsageDetailsResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
// Predefined struct for user
type DescribeCustomerVoucherUsageDetailsRequestParams struct {
	// Page number, starting from 1
	Page *int64 `json:"Page,omitnil,omitempty" name:"Page"`
...
type DescribeCustomerVoucherUsageDetailsRequest struct {
	*tchttp.BaseRequest
...
func (r *DescribeCustomerVoucherUsageDetailsRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeCustomerVoucherUsageDetailsRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "Month")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DescribeCustomerVoucherUsageDetailsRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DescribeCustomerVoucherUsageDetailsResponseParams struct {
	// Voucher information details
	Data []*UsageDetail `json:"Data,omitnil,omitempty" name:"Data"`
...
type DescribeCustomerVoucherUsageDetailsResponse struct {
	*tchttp.BaseResponse
	Response *DescribeCustomerVoucherUsageDetailsResponseParams `json:"Response"`
}

func (r *DescribeCustomerVoucherUsageDetailsResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeCustomerVoucherUsageDetailsResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type UsageDetail struct {
	...
	CompletionTime *string `json:"CompletionTime,omitnil,omitempty" name:"CompletionTime"`
